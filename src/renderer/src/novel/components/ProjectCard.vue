...
<template>
  <div
    class="md-card md-card-elevated group p-5 flex flex-col justify-between transition-all duration-300 hover:scale-[1.01] cursor-pointer"
  ...
  >
    ...
    <!-- Action Buttons -->
    <div class="project-card-actions flex gap-2 transition-all duration-300">
      <button
