...
<template>
  <div class="space-y-4 max-h-96 overflow-y-auto p-1">
    <div v-for="(relationship, index) in localRelationships" :key="relationship.id || index" class="p-4 border border-gray-200 rounded-lg bg-gray-50 relative">
...
import { ensureRelationship } from '@renderer/services/novel/blueprint-asset';
