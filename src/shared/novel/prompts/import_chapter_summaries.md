...
{
  "summaries": [
    { "chapter_number": 1, "summary": "本章主要情节摘要" }
  ]
}
```
...
4. **准确性优先**：保留关键人物、冲突、转折与伏笔；人物/地名必须用正文原名，严禁编造。
5. **简洁**：每条 summary 80-180 字，中文成品；禁止写思考过程、字数要求或英文键名。
6. **直接可用**：summary 必须是可直接展示给作者的情节摘要，不要出现「我需要」「本章摘要应」等元叙述。
