...
2.  **文学性与文笔**: 语言是否精炼、优美？描写是否生动、有感染力？叙事节奏是否恰当？是否存在语病、错别字或表达不清之处？
...
8.  **字数合规性**: 版本字数是否接近 chapter_outline 中该章的 target_word_count（或用户提供的规划字数）？是否存在明显偏短/偏长？
9.  **反重复质量**: 是否存在与上一章或本章内部重复的段落、对话、意象？重复严重者应扣分并避免选为 best_choice。
